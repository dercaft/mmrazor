...
def parse_args():
    ...
    # Adder start file
    parser.add_argument('--start_file_path', help='the dir of pruned but not retrained models')
...
def main():
    ...
    if hasattr(args, 'start_file_path') and args.start_file_path is not None:
        start_ckpt=load_checkpoint(algorithm, args.start_file_path, map_location='cpu', strict=True)
